...
> **MOD（2026-08-17）**：本文保留为迁移过程记录。文中“尚无正式 top、尚未
> UNROLL”等描述已经过期；当前修改及仍待验证项目统一记录在
> `docs/Accumulator修改说明.md`。未生成新综合报告前，不把源码中的
> `LATENCY min=15 max=15` 当成已经达到15个物理时钟的证据。
